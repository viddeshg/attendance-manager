...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { cc: @attendance.cc, date: @attendance.date, rollno: @attendance.rollno } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { cc: @attendance.cc, date: @attendance.date, rollno: @attendance.rollno } }
