...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { cc: @lecture.cc, dateOfLecture: @lecture.dateOfLecture, qrkey: @lecture.qrkey } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { cc: @lecture.cc, dateOfLecture: @lecture.dateOfLecture, qrkey: @lecture.qrkey } }
